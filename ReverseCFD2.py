...
if __name__ == '__main__':
    ...
    solver.inlet_mask = fx == it.fish.get("OutletMaskX")
    solver.outlet_mask = fx == it.fish.get("InletMaskX")
    ...
    def load
        loop i(1+Pnum+Rnum+Pnum,Pnum+Rnum+Pnum+Rnum)
            command
